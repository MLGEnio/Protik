					...
					>
						<div
							...
							style={{
								...
								height: expandedCardIndex === index ? '600px' : '500px',
							}}
						...
						>
							...
							{expandedCardIndex === index ? (
								<div className="grid grid-cols-2 h-full">
									...
									<img src={project.photo} alt={project.name} className="h-full max-h-[550px] bg-cover bg-center object-center fit-content ml-2 rounded-lg"/>
								</div>
							) : (
