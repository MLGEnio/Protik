            ...
            },
            {
                ...
                subcategories: [
                    ...
                    },
                    {
                        title: 'strategy',
                        subcategories: [
                            { title: 'competitive analysis', subcategories: [] },
...
const Preferences = () => {
    ...
    const handleCardClick = (card) => {
        ...
        if (isSelected) {
            setSelectedCards(selectedCards.filter((title) => title !== card.title));
        } else {
        ...
        return cards.flatMap((card) => [
            <div
                ...
                className={`m-1 p-2 cursor-pointer border rounded-3xl border-purple-600  text-white ${
                    selectedCards.includes(card.title) ? 'bg-purple-600 ' : 'bg-black bg-opacity-40 '
                }`}
            >
                {card.title}
            </div>,
